...
% TODO: enlazar stress tensor. Potencialmente cambiar el nombre
function greenwallfcn = greenwall(nodes,x,iopt)

numnodes = size(nodes,1);

% memory assigment
greenwallfcn = cell(numnodes,1);
...
%     parfor i = 1:numnodes
    for i = 1:numnodes
        ...
        greenwallfcn{i} = stokesletwall(nodex0,x,0);
    end
