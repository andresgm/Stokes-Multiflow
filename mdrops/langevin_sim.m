...
nombredestino = 'it';
carpetadestino = 'prueba_langevin_1';
...
%     geom.normalele = geomprop.normalele;
    ...
    parmsfem.xg = xg;
    parmsfem.wg = wg;
    parmsfem.Metricctr = Metricgctr;
    parmsfem.Jacmetctr = Jacmetctr;
...
%     parms.lmin = lmin;
    ...
    [velnode1,geom,parms] = stokes_langevin(geom,parms,parmsfem);
    ...
    [velnode,geom,parms] = stokes_langevin(geom,parms,parmsfem);
...
% guarde resultados
    if counter == outputfreq
        ...
        save(nombrearchivo,'geom','velnode','parms','parmsfem');
    end
%     disp(carpetadestino)
